...
This is a frozen copy of the code snapshot that produced
submission-20251127090903 (Public 0.92435) via the quick-test-xgb-pruned
template. Kept separate to avoid impacting current model files.
"""
...
VARIANT_NAME = "baseline-pruned-top"
...
def train(
    ...
    hyperparameter_tune_kwargs = getattr(hyper_cfg, 'hyperparameter_tune_kwargs', None)
    ...
    fit_kwargs = {
        ...
        # Explicitly pin stack levels to avoid preset auto-expansion
        'ag_args_fit': {'stack_ensemble_levels': num_stack_levels},
    }
...
if __name__ == "__main__":
    print("This model uses MINIMAL features + automatic feature pruning (frozen top run).")
    print("Run via experiment_manager.py with template: quick-test-xgb-pruned-top")
