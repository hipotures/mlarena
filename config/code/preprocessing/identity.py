...
def fit_transform(train_df: pd.DataFrame, val_df: pd.DataFrame | None, test_df: pd.DataFrame, config: Dict[str, Any]) -> Tuple[pd.DataFrame, pd.DataFrame | None, pd.DataFrame, Dict[str, Any]]:
