...
**Competition URL:** https://www.kaggle.com/competitions/playground-series-s5e10
...
### Evaluation Metric
**ROC AUC Score** - root_mean_squared_error (lower is better) between predicted probability and observed target.
