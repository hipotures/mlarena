"""
AutoGluon variant #6: base EDA features + non-linear terms for DTI and interest rate.
"""
...
def train(
    ...
    print(f"[{VARIANT_NAME}] Training with dti_squared + interest_rate_squared.")
