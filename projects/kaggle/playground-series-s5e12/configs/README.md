...
Defines experiment templates that combine model implementations with their hyperparameter configurations. Preprocess templates live in `templates/preprocess.yaml`.
