"""Configuration for playground-series-s6e1"""
...
AUTOGLUON_EVAL_METRIC = "root_mean_squared_error"  # AutoGluon metric (approximates Kaggle metric if different)

# Competition details
COMPETITION_NAME = "playground-series-s6e1"
METRIC = "root_mean_squared_error"  # Kaggle evaluation metric
