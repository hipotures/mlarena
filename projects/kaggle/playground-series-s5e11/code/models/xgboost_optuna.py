...
def train(
    ...
    # Cast categorical columns to pandas category for native handling
    ...
    if best_params_file.exists():
        ...
        if not config.optuna.study_name:
            config.optuna.study_name = f"xgb_{config.system.experiment_id}"
    ...
    # Ensure categorical support flags are present for native categories
