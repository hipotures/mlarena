...
# Sample 10% of training data and reset index
...
# Create aggregation features including EWMA
agg_features = []
agg_feature_names = []
mean_features = []
...
# Create interaction features between mean aggregations
...
# Add polynomial features starting from the non-linear terms
