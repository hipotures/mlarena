...
def compute_adversarial_weights(
    ...
    # Configure hyperparameters for native categorical handling in boost models
    hyperparameters = {
        'GBM': {},  # LightGBM uses category dtype natively
    ...
    fit_kwargs["ag_args_fit"] = {"random_seed": random_seed}
