...
# Definicje 10 wariantów selektora
variants = {
    "v01": {"selection_method": "model_importance", "importance_model_type": "lgbm", "min_importance": 1.0, "n_features": None},
    "v02": {"selection_method": "model_importance", "importance_model_type": "lgbm", "min_importance": 5.0, "n_features": None},
    "v03": {"selection_method": "model_importance", "importance_model_type": "lgbm", "importance_cumulative": 0.95, "n_features": None},
    "v04": {"selection_method": "model_importance", "importance_model_type": "lgbm", "importance_cumulative": 0.90, "n_features": None},
    "v05": {"selection_method": "mi", "n_features": 0.7},
    "v06": {"selection_method": "mi", "n_features": 0.5},
    "v07": {"selection_method": "rfe", "importance_model_type": "lgbm", "n_features": 30},
    "v08": {"selection_method": "rfe", "importance_model_type": "rf", "n_features": 30},
    "v09": {"selection_method": "l1", "n_features": None},
    "v10": {"selection_method": "correlation", "n_features": 0.8},
}

def generate():
    # 1. Load base model template to clone it
    with open(ROOT / f"templates/model/{BASE_NAME}.yaml", "r") as f:
        base_model = yaml.safe_load(f)

    for v_id, config in variants.items():
        ...
        print(f"Generated {v_id}: model={model_name}, chain={chain_name}, selector={selector_name}")
