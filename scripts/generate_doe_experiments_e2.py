"""
Generate 48 DOE experiment templates (E36-E83) for playground-series-s6e1.
"""
...
from doe_experiments_spec_e2 import EXPERIMENTS
...
# Baseline HPO config (copied from 20260101120000_baseline.yaml)
HPO_CONFIG = {
    "preset": "best",
    "time_limit": 3600,
    "use_gpu": False,
...
def main():
    ...
    print("=" * 80)
    print("Generating DOE Experiment Templates (Phase 2) for playground-series-s6e1")
    print("=" * 80)
    print()
